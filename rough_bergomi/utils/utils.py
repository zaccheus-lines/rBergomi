"""
Utility functions for the Rough Bergomi model implementation.

This module contains various utility functions used throughout the package,
including the TBSS kernel for the variance process and Black-Scholes related calculations.
"""
...
def bs_delta(S0: float, K: float, T: float, r: float, sigma: float) -> float:
